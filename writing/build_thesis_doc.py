...
p("Work on this thesis began on a single workstation with an Intel i9-10900X "
  ...
  "moved partway through to a replacement machine — an Intel i9-10980XE (18 "
  "cores, 36 threads), 251 gigabytes of RAM, and four NVIDIA RTX 3090 Ti "
  "cards — because the original's memory could not hold F-DATA's embedding "
...
p("NAS Parallel Benchmarks and Rodinia's kernel suite were the natural "
  ...
  "Benchmarks kernels (Bailey et al. 1991) — but no claim is made that these "
